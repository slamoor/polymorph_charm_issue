...
class CkIndex_Hello:public CkIndex_ArrayElement{
  public:
    ...
    /* DECLS: void SayHi(const BaseIntervention &b);
     */
    // Entry point registration at startup
    ...
    inline static int idx_SayHi(void (Hello::*)(const BaseIntervention &b) ) {
      return idx_SayHi_marshall2();
    }


    
    static int SayHi(const BaseIntervention &b) { return idx_SayHi_marshall2(); }
 ...
 */
    ...
    void SayHi(const BaseIntervention &b, const CkEntryOptions *impl_e_opts=NULL) ;
